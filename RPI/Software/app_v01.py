...
upButton = GPIO.input(11)
enterButton = GPIO.input(15)
downButton = GPIO.input(16)
backButton = GPIO.input(13)
##########################
## ~ FUNCTIONS ~ ##
def start(welcome):
	startCurses(stdscr,pad)
	presentUSB = findUSB()
	if welcome:
